...
<body ng-app="app">
	<form name="form" ng-controller="ctrl">
		<h2>ui-ch-phone-number-mask</h2>
		<input type="text" name="freeLinePhoneNumber" ng-model="freeLinePhoneNumber" ng-model-options="{allowInvalid:true}" ui-ch-phone-number-mask><br>
		<span ng-bind="freeLinePhoneNumber">-</span> - {{form.freeLinePhoneNumber.$error}}<br>
		<br>
		<input type="text" name="phoneNumber" ng-model="phoneNumber" ng-model-options="{allowInvalid:true}" ui-ch-phone-number-mask><br>
		<span ng-bind="phoneNumber">-</span> - {{form.phoneNumber.$error}}<br>
		<br>
		<input type="text" name="initializedPhoneNumber" ng-model="initializedPhoneNumber" ng-model-options="{allowInvalid:true}" ui-ch-phone-number-mask><br>
