...
<body ng-app="app">
	<form name="form" ng-controller="ctrl">
		<h2>ui-fr-phone-number-mask</h2>
		<input id="fr-phone-input" type="text" name="phoneNumberTest" ng-model="phoneNumber" ng-model-options="{allowInvalid:true}" ui-fr-phone-number-mask><br>
		<span id="fr-phone-value">{{phoneNumber}}</span> - {{form.phoneNumberTest.$valid}}

		<br>
		<br>

		<input id="init-fr-phone-input" type="text" name="initializedPhoneNumberTest" ng-model="initializedPhoneNumber" ng-model-options="{allowInvalid:true}" ui-fr-phone-number-mask><br>
